<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Principal2.Master" AutoEventWireup="true" CodeBehind="papeleria.aspx.cs" Inherits="Presentation_Layer.CATALOGOS.papeleria" %>
                  ...
                  <div class="subnavbar-inner">
                    <div class="container">
                      <ul class="mainnav">
                          ...
                          <li class="active"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-book"></i><span class="dropdown">CATALOGOS</span><b class="caret"></b> </a> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div style="text-align:center;">
       &nbsp;<!--ENCABEZADO DE LA SOLICITUD--><h1 style="color:#238ab1">CATÁLOGO DE ARTICULOS DE PAPELERIA</h1>
    </div>
     <div style="text-align:center;">
	    ...
	    <div class="container">
         ...
         <div class="span12" id="DivListaEquipos" runat="server">
            ...
            <!-- /widget-header -->
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <asp:button runat="server" text="AGREGAR NUEVO" ID="btnAgregarNuevo" OnClick="btnAgregarNuevo_Click" />
                 <asp:GridView ID="GridPapeleria" runat="server" AutoGenerateColumns="False" DataKeyNames="ID_ARTICULO" DataSourceID="SqlDataSourceArticulos" CssClass="table  table-bordered" AllowPaging="True" OnRowCommand="GridPapeleria_RowCommand">
                     <Columns>
                 ...
                 <asp:SqlDataSource ID="SqlDataSourceArticulos" runat="server" ConnectionString="<%$ ConnectionStrings:AlmacenConnectionString %>" SelectCommand="SELECT ID_ARTICULO, NOMBRE, MARCA, MODELO, FAMILIA, DESCRIPCION, CANTIDAD FROM ARTICULOS WHERE (FAMILIA = 'PAPELERIA') ORDER BY NOMBRE" FilterExpression="NOMBRE LIKE '%{0}%'">
                     <FilterParameters>
         ...
         <div class="span12" id="DivAgregarArticulos" runat="server">
	        <div id="Div3" class="widget">	<div class="widget-header"> <i class="icon-edit"></i>
              EDITAR ARTICULO
            </div>	
                <div class="widget-content">
                    <center><h3><i class="shortcut-icon icon-edit" style="font-size:25px"></i> FORMULARIO PARA LA EDICIÓN DE ARTICULOS</h3> <br />         
