<%@ Page Title="" Language="C#" MasterPageFile="~/Principal2.Master" AutoEventWireup="true" CodeBehind="mantenimiento.aspx.cs" Inherits="Presentation_Layer.CATALOGOS.mantenimiento" %>
                  ...
                  <div class="subnavbar-inner">
                    <div class="container">
                      <ul class="mainnav">
                          ...
                          <li class="active">
                              <asp:linkbutton runat="server" ID="btnAgregarServicios" OnClick="btnAgregarServicios_Click"><i class="icon-plus-sign"></i><span>AGREGAR SERVICIO</span></asp:linkbutton>
                              </li>    
                      </ul>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="text-align:center;">
       &nbsp;<!--ENCABEZADO DE LA SOLICITUD--><h1 style="color:#238ab1">CATÁLOGO DE SERVICIOS</h1>
    </div>
     <div style="text-align:center;">
	    ...
	    <div class="container">
         ...
         <div class="span12" id="DivListaEquipos" runat="server">
            ...
            <!-- /widget-header -->
                    ...
                    <asp:GridView ID="GridServicios" runat="server" AutoGenerateColumns="False" DataKeyNames="ID_ARTICULO" DataSourceID="SqlDataSourceArticulos" CssClass="table  table-bordered" AllowPaging="True" OnRowCommand="GridServicios_RowCommand">
                     <Columns>
                         <asp:BoundField DataField="ID_ARTICULO" HeaderText="CODIGO" ReadOnly="True" SortExpression="ID_ARTICULO" />
                         <asp:BoundField DataField="NOMBRE" HeaderText="NOMBRE" SortExpression="NOMBRE" />
                         <asp:BoundField DataField="MARCA" HeaderText="MARCA" SortExpression="MARCA" Visible="False" />
                 ...
                 <asp:SqlDataSource ID="SqlDataSourceArticulos" runat="server" ConnectionString="<%$ ConnectionStrings:AlmacenConnectionString %>" SelectCommand="SELECT ID_ARTICULO, NOMBRE, MARCA, MODELO, FAMILIA, DESCRIPCION, CANTIDAD FROM ARTICULOS WHERE (FAMILIA = 'MANTENIMIENTO') ORDER BY NOMBRE" FilterExpression="NOMBRE LIKE '%{0}%'">
                     <FilterParameters>
         ...
         <div class="span12" id="DivAgregarArticulos" runat="server">
	        <div id="Div3" class="widget">	<div class="widget-header"> <i class="icon-plus-sign"></i>
              <h3>AGREGAR SERVICIOS</h3>
                ...
                <div class="widget-content">
                    <center><h3><i class="shortcut-icon icon-edit" style="font-size:25px"></i> FORMULARIO PARA EL REGISTRO DE SERVICIOS</h3> <br />         
                          ...
                          <tr>
                            ...
                            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                      ...
                                                      <div class="modal-footer">
                                                          <asp:Button runat="server" Text="SI" ID="btnCancelar" CssClass="btn btn-danger"  OnClientClick="#MyModal" OnClick="btnCancelar_Click"></asp:Button>
                                                      </div>
                                                    </div>
		      		</div> <!-- /widget-content -->
	      		</div> 
